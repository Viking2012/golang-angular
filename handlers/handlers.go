...
import (
	...
	"github.com/Viking2012/golang-angular/todo"
...
// DeleteTodoHandler deletes a specified todo item based on uder http input
...
// CompleteTodoHandler will mark a specific todo item as complete, based on user http input
